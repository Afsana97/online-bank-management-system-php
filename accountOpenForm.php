...
<body>
    <header class="header bg-success">
        <div class="container ">
            <div class="row">
                ...
                <div class="col-md-6">
                    <span  style="float:right;margin-top:5px;"><a href="Admin-page.php">Back</a></span>
                </div>
            </div>
        </div>
    </header>
    <main>
        <div class="container" style="height:600px">
            ...
            <br><br>
            <form class="row g-3 border shadow-lg py-4" action="accountopenDb.php" method="POST">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <label for="acc-no" class="form-label">Account Number</label>
                    <input type="password" class="form-control" id="acc-no" name="acc-no" placeholder="Account Number" required>
                    <br>
                </div>    
                <div class="col-md-6">
