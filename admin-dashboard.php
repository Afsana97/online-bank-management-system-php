        ...
        <div class="container" style="height:400px;width:800px;margin-left:400px ; margin-top:200px">
            ...
            <form class="row g-3 border shadow-lg py-4" style="height:200px">
                <div class="d-grid gap-2 col-md-6">      
                    <button type="submit" class="btn btn-success" name="viewrequest" value="submit"><a href="view-request.php">View Request</a></button>
                </div> 
                <div class="d-grid gap-2 col-md-6">      
                    <button type="submit" class="btn btn-success" name="newaccount" value="submit"><a href="accountOpenForm.php">Create New Account</a></button>
                </div> 
                <div class="d-grid gap-2 col-md-6">      
                    <button type="submit" class="btn btn-success" name="viewaccount" value="submit"><a href="view-accounts.php">View Accounts</a></button>
                </div>   
                <div class="d-grid gap-2 col-md-6">      
